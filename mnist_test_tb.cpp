...
int main(){
    ...
    weight_grad = new TYPE_GRAD[WD * 8];
    bias = new TYPE_DATA[HS + OS];
    bias_grad = new TYPE_GRAD[HS + OS];

    load_file(weight, "weight0.bin", 7*4*16);
    load_file(weight + WD, "weight1.bin", 16*4*4*16);
    load_file(weight + WD * 2, "weight2.bin", 16*2*2*16);
    load_file(weight + WD * 3, "weight3.bin", 16*16*16);
    load_file(weight + WD * 5, "weight4.bin", 32*16);
    load_file(weight + WD * 6, "weight5.bin", 16*16*16);
    load_file(bias, "bias0.bin", 512);
    load_file(bias + HS, "bias1.bin", 16);
    load_file(data_input_output_buffer, "input.bin", 28*32*100);
    ...
    save_file(weight_grad + WD, "weight_grad1.bin", 16*4*4*16);
    save_file(weight_grad + WD * 2, "weight_grad2.bin", 16*2*2*16);
    save_file(weight_grad + WD * 3, "weight_grad3.bin", 16*16*16);
    save_file(weight_grad + WD * 5, "weight_grad4.bin", 32*1*16);
    save_file(weight_grad + WD * 6, "weight_grad5.bin", 16*16*16);
